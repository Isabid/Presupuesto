function formatearYMostrar(input) {
  ...
  let valorLimpio = valorOriginal.replace(/,/g, '').replace(/\./g, '');
...
function enviarFormulario() {
  ...
  console.log('Valor original de enero:', formData.get('enero'));
  formData.set('enero', limpiarNumero(formData.get('enero')));
  console.log('Valor limpiado de enero:', formData.get('enero'));
  formData.set('r1', limpiarNumero(formData.get('r1')));
  formData.set('febrero', limpiarNumero(formData.get('febrero')));
  formData.set('marzo', limpiarNumero(formData.get('marzo')));
  // Repite esto para otros campos que estás limpiando
